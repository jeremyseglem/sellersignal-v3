...
const STATE_METRO_LABELS = { WA: 'Seattle', AZ: 'Phoenix', CT: 'Greenwich', FL: 'Palm Beach', MA: 'Boston', TN: 'Nashville', NC: 'Raleigh' };
...
const STATE_NAMES = { WA: 'Washington', AZ: 'Arizona', TX: 'Texas', CT: 'Connecticut', FL: 'Florida', MT: 'Montana', MA: 'Massachusetts', TN: 'Tennessee', CO: 'Colorado', NC: 'North Carolina' };
