...
ZIP_CONFIG = {
    ...
    # WI expansion (2026-07-31) — Lake Country / Madison / Door County, statewide layer
    "53018": ("Delafield",     {"DELAFIELD"}),
    "53066": ("Oconomowoc",    {"OCONOMOWOC"}),
    "53072": ("Pewaukee",      {"PEWAUKEE"}),
    "53058": ("Nashotah",      {"NASHOTAH", "MERTON"}),
    "53012": ("Cedarburg",     {"CEDARBURG"}),
    "53213": ("Wauwatosa",     {"WAUWATOSA"}),
    "53705": ("Madison",       {"MADISON", "SHOREWOOD HILLS"}),
    "53704": ("Madison",       {"MADISON", "MAPLE BLUFF"}),
    "54212": ("Fish Creek",    {"FISH CREEK", "BAILEYS HARBOR", "GIBRALTAR"}),
    "54211": ("Ephraim",       {"EPHRAIM", "GIBRALTAR"}),
    "54234": ("Sister Bay",    {"SISTER BAY", "GIBRALTAR", "LIBERTY GROVE"}),
    "54209": ("Egg Harbor",    {"EGG HARBOR", "EATON"}),
