...
async def register_zip(
    ...
    if zip_code in NC_BUNCOMBE_ZIP_TO_CITY and market_key == "WA_KING":
    ...
    if zip_code in MN_ZIP_TO_CITY and market_key == "WA_KING":
...
async def onboard_zip(
    ...
    if is_ncwake and market_key == "WA_KING":
        ...
        if state in (None, "WA"):
            state = "NC"
    is_ncbuncombe = zip_code in NC_BUNCOMBE_ZIP_TO_CITY
    if is_ncbuncombe and market_key == "WA_KING":
        market_key = "NC_BUNCOMBE"
        if state in (None, "WA"):
            state = "NC"
    ...
    if is_wi and market_key == "WA_KING":
        ...
        if state in (None, "WA"):
            state = "WI"
    is_mn = zip_code in MN_ZIP_TO_CITY
    if is_mn and market_key == "WA_KING":
        market_key = "MN_HENNEPIN"
        if state in (None, "WA"):
            state = "MN"
...
MT_ZIP_TO_CITY = {
    ...
    "59047": "Livingston", "59027": "Emigrant", "59030": "Gardiner",
    "59840": "Hamilton", "59860": "Polson", "59068": "Red Lodge",
}
MT_ZIP_MARKET = {
    "59715": "MT_GALLATIN",
    "59718": "MT_GALLATIN",
    ...
    "59047": "MT_PARK", "59027": "MT_PARK", "59030": "MT_PARK",
    "59840": "MT_RAVALLI", "59860": "MT_LAKE", "59068": "MT_CARBON",
}
...
CO_ZIP_TO_CITY = {
    ...
    # Boulder wave 1 (2026-07-30)
    "80302": "Boulder",           # Chautauqua / Mapleton Hill / foothills
    "80304": "Boulder",           # North Boulder
    "80305": "Boulder",           # South Boulder / Table Mesa
    "80303": "Boulder",           # East Boulder / Gunbarrel
    "80301": "Boulder",           # Northeast Boulder
    # Arapahoe wave 1 (2026-07-30) — Denver-suburb ultra-lux
    "80113": "Cherry Hills Village",
    "80111": "Greenwood Village",
    "80121": "Greenwood Village",
    "80122": "Centennial",
    "80110": "Cherry Hills Village",
}
CO_ZIP_MARKET = {
    "81611": "CO_PITKIN",
    "81615": "CO_PITKIN",
...
# Buncombe County NC (2026-07-31) — Asheville (market_key NC_BUNCOMBE).
# Situs-ZIP native (Zipcode). Seeds data/seeds/nc-buncombe-{zip}-owners.json.
NC_BUNCOMBE_ZIP_TO_CITY = {
    "28801": "Asheville", "28803": "Asheville", "28804": "Asheville",
...
# Minnesota (2026-07-31) — first MN (market_key MN_HENNEPIN). Lake Minnetonka + Edina
# + Minneapolis lakes. HennCarv full-signal layer (owner+situs+sale+value+geometry).
# Seeds data/seeds/mn-hennepin-{zip}-owners.json.
MN_ZIP_TO_CITY = {
    "55391": "Wayzata", "55356": "Long Lake", "55364": "Mound", "55331": "Excelsior",
...
async def seed_from_json_zip(zip_code: str = Path(..., pattern=r'^\d{5}$')):
    ...
    elif zip_code in NC_BUNCOMBE_ZIP_TO_CITY:
        market_key = "NC_BUNCOMBE"
        city = NC_BUNCOMBE_ZIP_TO_CITY[zip_code]
    ...
    elif zip_code in MN_ZIP_TO_CITY:
        market_key = "MN_HENNEPIN"
        city = MN_ZIP_TO_CITY[zip_code]
...
def _load_seed_names(zip_code: str) -> dict:
    ...
    if market_key == 'CO_BOULDER' or zip_code.startswith('803'):
