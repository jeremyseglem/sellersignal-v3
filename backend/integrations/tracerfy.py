...
def _do_lookup(
    *,
    ...
    trace). Tracerfy's marketed "Enhanced Skip Tracing" tier (15
    credits, 8 relatives) is NOT exposed in their public API — the
    trace_type parameter on this endpoint silently ignores 'enhanced',
    and the batch endpoint only accepts trace_type values normal,
    advanced, custom. Verified experimentally 2026-05-13.
