    ...
    for p in parcels:
        ...
        if raw_pt in {'R', 'K'}:
            final_pt = raw_pt
                        ...
                        'CO_ARAPAHOE', 'NC_WAKE', 'NC_BUNCOMBE', 'WI_MILWAUKEE', 'MN_HENNEPIN', 'CA_SANTACLARA', 'FL_COLLIER', 'FL_INDIAN_RIVER'}:
            final_pt = 'R'
        elif not raw_pt:
            final_pt = 'R'
        else:
...
SOURCE_MARKET_SCOPE: dict = {
    ...
    'maricopa_probate_court': {'AZ_MARICOPA'},  # Superior Court probate docket (decedent estates)
    ...
    'mt_district_court':    {'MT_GALLATIN', 'MT_FLATHEAD', 'MT_PARK', 'MT_RAVALLI', 'MT_LAKE', 'MT_CARBON'},  # FullCourt Web (probate/divorce)
