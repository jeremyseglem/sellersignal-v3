...
from banding import classify_lead, rank_score, SIGNAL_PROFILES
...
for L in manifest['leads']:
    ...
    if fam == 'financial_stress':
        ...
        from rationality_index import score_rationality_partial
...
from rebuild_band_assignments import (
