...
from backend.pipeline.schema import CandidateReview, Lead
from backend.pipeline.candidate_search import (
    build_person_index,
...
from backend.pipeline.candidate_review import review_all_candidates, apply_cross_family_support
from backend.pipeline.lead_builder import build_leads
from backend.pipeline.briefing_render import render_briefing_markdown, render_briefing_manifest
...
def run_pipeline(
    ...
    from backend.pipeline.decision_signals import build_entity_activity_index
    ...
    from backend.pipeline.candidate_search import search_failed_sale_attempt_candidates
    ...
    if divorce_filings_csv:
        from backend.pipeline.legal_filings import load_divorce_filings_csv, match_divorce_to_parcels
    ...
    if recorder_docs_csv:
        from backend.pipeline.legal_filings import load_recorder_documents_csv, match_recorder_to_parcels
    ...
    from backend.pipeline.briefing_render import group_absentee_oos_by_owner
