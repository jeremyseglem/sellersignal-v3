...
from backend.pipeline.schema import CandidateReview, Evidence
from backend.pipeline.evidence_resolution import (
...
from backend.pipeline.signal_registry import SIGNAL_REGISTRY
...
def apply_cross_family_support(reviews: list[CandidateReview]) -> list[CandidateReview]:
    ...
    for r in reviews:
        ...
        from backend.pipeline.evidence_resolution import classify_candidate as _classify
