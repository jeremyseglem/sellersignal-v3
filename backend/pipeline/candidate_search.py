...
from backend.pipeline.evidence_resolution import is_entity_owner, is_business_entity, is_family_trust
...
def search_failed_sale_attempt_candidates(
    ...
    """
    from backend.pipeline.zillow_listings import (
...
def search_financial_stress_candidates(*args, **kwargs) -> list[dict]:
    ...
    automated queries, so this requires county recorder direct access or
    alternative legal filings feed. Returns [].
    """
    return []
